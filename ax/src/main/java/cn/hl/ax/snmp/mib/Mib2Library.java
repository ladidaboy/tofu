...
public class Mib2Library {
    ...
    private static int arrayContains(int[] big, int[] small) {
        if (big == null || small == null || small.length == 0 || big.length < small.length) {
            return -1;
        }
    ...
    public static final Mib LanMgr                       = put("lanMgr", "1.3.6.1.4.1.77", "ObjectIdentifier", AccessMode.Read, "[LAN Manager]");
    public static final Mib LanMgr2                      = put("lanMgr2", LanMgr.child(1), "ObjectIdentifier", AccessMode.Read, "");
    public static final Mib LanMgrCommon                 = put("lanMgrCommon", LanMgr2.child(1), "ObjectIdentifier", AccessMode.Read, "");
    public static final Mib comVersionMaj                = put("comVersionMaj", LanMgrCommon.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib comVersionMin                = put("comVersionMin", LanMgrCommon.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib comType                      = put("comType", LanMgrCommon.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib comStatStart                 = put("comStatStart", LanMgrCommon.child(4), "OctetString", AccessMode.Read, "");
    public static final Mib comStatNumNetIOs             = put("comStatNumNetIOs", LanMgrCommon.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib comStatFiNetIOs              = put("comStatFiNetIOs", LanMgrCommon.child(6), "OctetString", AccessMode.Read, "");
    public static final Mib comStatFcNetIOs              = put("comStatFcNetIOs", LanMgrCommon.child(7), "OctetString", AccessMode.Read, "");
    public static final Mib LanMgrServer                 = put("lanMgrServer", LanMgr2.child(2), "ObjectIdentifier", AccessMode.Read, "");
    public static final Mib SvDescription                = put("svDescription", LanMgrServer.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcNumber                  = put("svSvcNumber", LanMgrServer.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcTable                   = put("svSvcTable", LanMgrServer.child(3), "Sequence.SvSvcEntry", AccessMode.Read, "");
    public static final Mib SvSvcEntry                   = put("svSvcTable", SvSvcTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib SvSvcName                    = put("svSvcName", SvSvcEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcInstalledState          = put("svSvcInstalledState", SvSvcEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcOperatingState          = put("svSvcOperatingState", SvSvcEntry.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcCanBeUninstalled        = put("svSvcCanBeUninstalled", SvSvcEntry.child(4), "OctetString", AccessMode.Read, "");
    public static final Mib SvSvcCanBePaused             = put("svSvcCanBePaused", SvSvcEntry.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatOpens                  = put("svStatOpens", LanMgrServer.child(4), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatDevOpens               = put("svStatDevOpens", LanMgrServer.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatQueuedJobs             = put("svStatQueuedJobs", LanMgrServer.child(6), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatSOpens                 = put("svStatSOpens", LanMgrServer.child(7), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatErrorOuts              = put("svStatErrorOuts", LanMgrServer.child(8), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatPwErrors               = put("svStatPwErrors", LanMgrServer.child(9), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatPermErrors             = put("svStatPermErrors", LanMgrServer.child(10), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatSysErrors              = put("svStatSysErrors", LanMgrServer.child(11), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatSentBytes              = put("svStatSentBytes", LanMgrServer.child(12), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatRcvdBytes              = put("svStatRcvdBytes", LanMgrServer.child(13), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatAvResponse             = put("svStatAvResponse", LanMgrServer.child(14), "OctetString", AccessMode.Read, "");
    public static final Mib SvSecurityMode               = put("svSecurityMode", LanMgrServer.child(15), "OctetString", AccessMode.Read, "");
    public static final Mib SvUsers                      = put("svUsers", LanMgrServer.child(16), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatReqBufsNeeded          = put("svStatReqBufsNeeded", LanMgrServer.child(17), "OctetString", AccessMode.Read, "");
    public static final Mib SvStatBigBufsNeeded          = put("svStatBigBufsNeeded", LanMgrServer.child(18), "OctetString", AccessMode.Read, "");
    public static final Mib SvSessionNumber              = put("svSessionNumber", LanMgrServer.child(19), "OctetString", AccessMode.Read, "");
    public static final Mib SvSessionTable               = put("svSessionTable", LanMgrServer.child(20), "Sequence.SvSessionEntry", AccessMode.Read, "");
    public static final Mib SvSessionEntry               = put("svSessionEntry", SvSessionTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib SvSesClientName              = put("svSesClientName", SvSessionEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesUserName                = put("svSesUserName", SvSessionEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesNumOpens                = put("svSesNumOpens", SvSessionEntry.child(4), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesTime                    = put("svSesTime", SvSessionEntry.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesIdleTime                = put("svSesIdleTime", SvSessionEntry.child(6), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesClientType              = put("svSesClientType", SvSessionEntry.child(7), "OctetString", AccessMode.Read, "");
    public static final Mib SvSesState                   = put("svSesState", SvSessionEntry.child(8), "OctetString", AccessMode.Read, "");
    public static final Mib SvAutoDisconnects            = put("svAutoDisconnects", LanMgrServer.child(21), "OctetString", AccessMode.Read, "");
    public static final Mib SvDisConTime                 = put("svDisConTime", LanMgrServer.child(22), "OctetString", AccessMode.Read, "");
    public static final Mib SvAuditLogSize               = put("svAuditLogSize", LanMgrServer.child(23), "OctetString", AccessMode.Read, "");
    public static final Mib SvUserNumber                 = put("svUserNumber", LanMgrServer.child(24), "OctetString", AccessMode.Read, "");
    public static final Mib SvUserTable                  = put("svUserTable", LanMgrServer.child(25), "Sequence.SvUserEntry", AccessMode.Read, "");
    public static final Mib SvUserEntry                  = put("svUserEntry", SvUserTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib SvUserName                   = put("svUserName", SvUserEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvShareNumber                = put("svShareNumber", LanMgrServer.child(26), "OctetString", AccessMode.Read, "");
    public static final Mib SvShareTable                 = put("svShareTable", LanMgrServer.child(27), "Sequence.SvShareEntry", AccessMode.Read, "");
    public static final Mib SvShareEntry                 = put("svShareEntry", SvShareTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib SvShareName                  = put("svShareName", SvShareEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvSharePath                  = put("svSharePath", SvShareEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib SvShareComment               = put("svShareComment", SvShareEntry.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib SvPrintQNumber               = put("svPrintQNumber", LanMgrServer.child(28), "OctetString", AccessMode.Read, "");
    public static final Mib SvPrintQTable                = put("svPrintQTable", LanMgrServer.child(29), "Sequence.SvPrintQEntry", AccessMode.Read, "");
    public static final Mib SvPrintQEntry                = put("svPrintQEntry", SvPrintQTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib SvPrintQName                 = put("svPrintQName", SvPrintQEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib SvPrintQNumJobs              = put("svPrintQNumJobs", SvPrintQEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib LanMgrWorkstation            = put("lanMgrWorkstation", LanMgr2.child(3), "ObjectIdentifier", AccessMode.Read, "");
    public static final Mib WkstaStatSessStarts          = put("wkstaStatSessStarts", LanMgrWorkstation.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaStatSessFails           = put("wkstaStatSessFails", LanMgrWorkstation.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaStatUses                = put("wkstaStatUses", LanMgrWorkstation.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaStatUseFails            = put("wkstaStatUseFails", LanMgrWorkstation.child(4), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaStatAutoRecs            = put("wkstaStatAutoRecs", LanMgrWorkstation.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaErrorLogSize            = put("wkstaErrorLogSize", LanMgrWorkstation.child(6), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaUseNumber               = put("wkstaUseNumber", LanMgrWorkstation.child(7), "OctetString", AccessMode.Read, "");
    public static final Mib WkstaUseTable                = put("wkstaUseTable", LanMgrWorkstation.child(8), "Sequence.WkstaUseEntry", AccessMode.Read, "");
    public static final Mib WkstaUseEntry                = put("wkstaUseEntry", WkstaUseTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib UseLocalName                 = put("useLocalName", WkstaUseEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib UseRemote                    = put("useRemote", WkstaUseEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib UseStatus                    = put("useStatus", WkstaUseEntry.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib LanMgrDomain                 = put("lanMgrDomain", LanMgr2.child(4), "ObjectIdentifier", AccessMode.Read, "");
    public static final Mib DomPrimaryDomain             = put("domPrimaryDomain", LanMgrDomain.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib DomLogonDomain               = put("domLogonDomain", LanMgrDomain.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib DomOtherDomainNumber         = put("domOtherDomainNumber", LanMgrDomain.child(3), "OctetString", AccessMode.Read, "");
    public static final Mib DomOtherDomainTable          = put("domOtherDomainTable", LanMgrDomain.child(4), "Sequence.DomOtherDomainEntry", AccessMode.Read, "");
    public static final Mib DomOtherDomainEntry          = put("domOtherDomainEntry", DomOtherDomainTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib DomOtherName                 = put("domOtherName", DomOtherDomainEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib DomServerNumber              = put("domServerNumber", LanMgrDomain.child(5), "OctetString", AccessMode.Read, "");
    public static final Mib DomServerTable               = put("domServerTable", LanMgrDomain.child(6), "Sequence.DomServerEntry", AccessMode.Read, "");
    public static final Mib DomServerEntry               = put("domServerEntry", DomServerTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib DomServerName                = put("domServerName", DomServerEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib DomLogonNumber               = put("domLogonNumber", LanMgrDomain.child(7), "OctetString", AccessMode.Read, "");
    public static final Mib DomLogonTable                = put("domLogonTable", LanMgrDomain.child(8), "Sequence.DomLogonEntry", AccessMode.Read, "");
    public static final Mib DomLogonEntry                = put("domLogonEntry", DomLogonTable.child(1), "Sequence", AccessMode.Read, "");
    public static final Mib DomLogonUser                 = put("domLogonUser", DomLogonEntry.child(1), "OctetString", AccessMode.Read, "");
    public static final Mib DomLogonMachine              = put("domLogonMachine", DomLogonEntry.child(2), "OctetString", AccessMode.Read, "");
    public static final Mib Alerts2                      = put("alerts2", LanMgr.child(2), "ObjectIdentifier", AccessMode.Read, "");
    /*private*/
    ...
    // VariableFormatter
    static {
        LogUtils.printLabel("ⓘ Mib2Library.mib.size = " + mibs.size());
    ...
    // ==-TEST-CODE-===========================================================================================================
    private Mib2Library() {
        LogUtils.printLabel("ⓘ [TEST-CODE] 构造方法执行了");
    }

    static {
        LogUtils.printError("ⓘ [TEST-CODE] 静态代码块执行了");
    }

    {
        LogUtils.printError("ⓘ [TEST-CODE] 普通代码块执行了");
    }

    public static void main(String[] args) {
        LogUtils.printLabel("ⓘ [TEST-CODE] main方法开始执行");
        new Mib2Library();
        LogUtils.printLabel("ⓘ [TEST-CODE] main方法执行完毕");
    }
}
