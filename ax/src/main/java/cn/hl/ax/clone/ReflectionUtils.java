    ...
    public static Field getDeclaredField(Object object, String fieldName) {
        ...
        for (; clazz != Object.class; clazz = clazz.getSuperclass()) {
            try {
                ...
                log.warn("Class<{}> {}", clazz.getSimpleName(), LogUtils.getSimpleMessages(e));
            }
        }
        return null;
    }
        ...
        try {
            ...
            switch (fieldType) {
                ...
                case "boolean":
                    ...
                    break;
                case "String":
                    field.set(object, DataUtils.convert2String(value));
                    break;
                case "Integer":
                    field.set(object, DataUtils.convert2Integer(value));
                    break;
                case "Date":
                    field.set(object, DataUtils.convert2Date(value));
                    break;
                default:
