 ...
 * <p>
 * 编辑距离的伪算法：
 * <br>		整数 Levenshtein距离(字符 str1[1..lenStr1], 字符 str2[1..lenStr2])
 * <br>			宣告 int d[0..lenStr1, 0..lenStr2]
 * <br>			宣告 int i, j, cost
 * <br>
 * <br>			对于 i 等于 由 0 至 lenStr1
 * <br>				d[i, 0] := i
 * <br>			对于 j 等于 由 0 至 lenStr2
 * <br>				d[0, j] := j
 * <br>			对于 i 等于 由 1 至 lenStr1
 * <br>			对于 j 等于 由 1 至 lenStr2
 * <br>			若 str1[i] = str2[j] 则 cost := 0
 * <br>			否则 cost := 1
 * <br>			d[i, j] := 最小值(
 * <br>				d[i-1, j ] + 1,			// 删除
 * <br>				d[i , j-1] + 1,			// 插入
 * <br>				d[i-1, j-1] + cost		// 替换
 * <br>			)
 * <br>			返回 d[lenStr1, lenStr2]
 * 
 * 
 * @author Halfman
 *
