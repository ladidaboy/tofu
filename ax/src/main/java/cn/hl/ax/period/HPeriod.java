...
public class HPeriod {
	...
	/**期数规则: 年月期数**/public static final String PATTERN_P_YM =
																	"("+PATTERN_P_YR + "-(0[1-9]))|"+
																	"("+PATTERN_P_YR + "-(1[0-2]))";
	/**期数规则: 季月期数**/public static final String PATTERN_P_QM =
																	"("+PATTERN_P_YR+"-Q1-(JAN|FEB|MAR))|"+
																	"("+PATTERN_P_YR+"-Q2-(APR|MAY|JUN))|"+
																	"("+PATTERN_P_YR+"-Q3-(JUL|AUG|SEP))|"+
																	"("+PATTERN_P_YR+"-Q4-(OCT|NOV|DEC))";
	/**期数规则: 单周期数**/public static final String PATTERN_P_WK =
																	"("+PATTERN_P_YR+"-Q1-(JAN|FEB|MAR)-W[1-4])|"+
