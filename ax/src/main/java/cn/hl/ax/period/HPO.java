...
public class HPO {
	...
	public static int getPeriodType(String _p_) {
		if (Pattern.matches(HPeriod.PATTERN_P_YR, _p_))
			return HPeriod.HP_YR;
		if (Pattern.matches(HPeriod.PATTERN_P_HY, _p_))
			return HPeriod.HP_HY;
		if (Pattern.matches(HPeriod.PATTERN_P_QT, _p_))
			return HPeriod.HP_QT;
		if (Pattern.matches(HPeriod.PATTERN_P_YM, _p_))
			return HPeriod.HP_YM;
		if (Pattern.matches(HPeriod.PATTERN_P_QM, _p_))
			return HPeriod.HP_QM;
		if (Pattern.matches(HPeriod.PATTERN_P_WK, _p_))
			return HPeriod.HP_WK;
		if (Pattern.matches(HPeriod.PATTERN_P_WV, _p_))
			return HPeriod.HP_WV;
		return HPeriod.HP_NA;
	}

	// ------------------------------------------------------------------------------------------------------------------------------
	public static boolean FRONT = true;// 统计期数前置OR后置
