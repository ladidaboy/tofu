...
public class DataTypeOfAdvanced extends DataTypeOfBasic {
	...
	public String info() {
		return "Son {ID=" + id + ", CODES=" + Arrays.toString(getCodes()) + ", LIST=" + getListValue() + ", MAP=" + getMapValue() + ", PARENT=" + getParent() + "}";
	}
	...
	public String toString() {
		return "Advanced {ID=" + id + ", Byte=" + getByteValue() + ", Character=" + getCharValue() + ", Short=" + getShortValue() + ", Integer="
				...
				+ getBooleanValue() + ", LIST=" + getListValue() + ", MAP=" + getMapValue() + ", CODES=" + getCodes() + "}";
	}
}
