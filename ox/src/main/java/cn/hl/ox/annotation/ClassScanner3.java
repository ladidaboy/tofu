...
public class ClassScanner3 {
     ...
     * 过滤器
     **/
    private MyScanPackageFilter   filter       = null;
    /**
     * 监听器
     **/
    private MyScanPackageListener listener     = null;
     ...
     * @return filter
     */
    public MyScanPackageFilter getFilter() {
        return filter;
    }
     ...
     * @param filter 过滤器
     */
    public void setFilter(MyScanPackageFilter filter) {
        this.filter = filter;
    }
     ...
     * @return listener
     */
    public MyScanPackageListener getListener() {
        return listener;
    }
     ...
     * @param listener 监听器
     */
    public void setListener(MyScanPackageListener listener) {
     ...
     * 扫描包过滤器
     */
    public interface MyScanPackageFilter {
        /**
         * 是否接受
         *
         * @param clazz Java类
     ...
     * 扫描包监听
     */
    public interface MyScanPackageListener {
        /**
         * 扫描到合法类执行
         *
         * @param clazz 合法类
    ...
    public static void main(String[] args) {
        ClassScanner3 scanPackage = new ClassScanner3();
        //scanPackage.addPackage(ClassScanner3.class.getPackage().getName());
        scanPackage.addPackage("cn.hl.ax.workflow");
        scanPackage.setFilter(clazz -> true);
        scanPackage.setListener(System.out::println);
        scanPackage.scan();
    }
}
