 ...
 * 
 * <p>A <em>Base64InputStream</em> reads from an underlying stream which is supposed to be a base64 encoded stream. 
 * <em>Base64InputStream</em> decodes the data read from the underlying stream and returns the decoded bytes to the caller.</p>
 * 
...
public class Base64InputStream extends InputStream {
	...
	/**
	 * <p>It builds a base64 decoding input stream.</p>
	 * 
