...
/**
 * <p>Base64 encoding and decoding utility methods, both for binary and textual informations.</p>
 * 
...
public class Base64 {
	 ...
	 * <p>Before the string is encoded in Base64, it is converted in a binary sequence using the system default charset.</p>
	 * 
	...
	/**
	 * <p>Encodes a string.</p>
	 * <p>Before the string is encoded in Base64, it is converted in a binary sequence using the supplied charset.</p>
	 * 
	 * @param str The source string
	...
	/**
	 * <p>Decodes the supplied string.</p>
	 * <p>The supplied string is decoded into a binary sequence, and then the sequence is encoded with the system default charset and returned.</p>
	 * 
	...
	/**
	 * <p>Decodes the supplied string.</p>
	 * <p>The supplied string is decoded into a binary sequence, and then the sequence is encoded with the supplied charset and returned.</p>
	 * 
	 * @param str The encoded string.
	 * @param charset The charset name.
	 * @return The decoded string.
	 ...
	 * consider to use a {@link Base64OutputStream} instead of loading too much data in memory.</p>
	 * 
	...
	/**
	 * <p>Encodes a binary sequence, wrapping every encoded line every <em>wrapAt</em> characters. 
	 * A <em>wrapAt</em> value less than 1 disables wrapping.</p>
	 * <p>If data are large, i.e. if you are working with large binary files,
	 * consider to use a {@link Base64OutputStream} instead of loading too much data in memory.</p>
	 * 
	 * @param bytes The source sequence.
	 ...
	 * <p>If data are large, i.e. if you are working with large binary files,
	 * consider to use a {@link Base64InputStream} instead of loading too much data in memory.</p>
	 * 
	...
	/**
	 * <p>Encodes data from the given input stream and writes them in the given output stream.</p>
	 * <p>The supplied input stream is read until its end is reached, but it's not closed by this method.</p>
	 * <p>The supplied output stream is nor flushed neither closed by this method.</p>
	 * 
	...
	/**
	 * <p>Encodes data from the given input stream and writes them in the given output stream, 
	 * wrapping every encoded line every <em>wrapAt</em> characters. A <em>wrapAt</em> value less than 1 disables wrapping.</p>
	 * <p>The supplied input stream is read until its end is reached, but it's not closed by this method.</p>
	 * <p>The supplied output stream is nor flushed neither closed by this method.</p>
	 * 
	...
	/**
	 * <p>Decodes data from the given input stream and writes them in the given output stream.</p>
	 * <p>The supplied input stream is read until its end is reached, but it's not closed by this method.</p>
	 * <p>The supplied output stream is nor flushed neither closed by this method.</p>
	 * 
	...
	/**
	 * <p>Encodes data from the given source file contents and writes them in the given target file, 
	 * wrapping every encoded line every <em>wrapAt</em> characters. A <em>wrapAt</em> value less than 1 disables wrapping.</p>
	 * 
	...
	/**
	 * <p>Encodes data from the given source file contents and writes them in the given target file.</p>
	 * 
	 * @param source The source file, from which decoded data are read.
	 * @param target The target file, in which encoded data are written.
	 * @throws IOException If an I/O error occurs.
	...
	/**
	 * <p>Decodes data from the given source file contents and writes them in the given target file.</p>
	 * 
