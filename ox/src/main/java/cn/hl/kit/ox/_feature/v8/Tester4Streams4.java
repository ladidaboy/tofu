...
public class Tester4Streams4 {
    public static void main(String[] args) {
        test1sorted();
        BuddhaBless.printCornerTitle("01");
        test2construct();
        BuddhaBless.printCornerTitle("02");
        test3intStream();
        BuddhaBless.printCornerTitle("03");
        test4change();
        BuddhaBless.printCornerTitle("04");
        test5map();
        BuddhaBless.printCornerTitle("05");
        test6square();
        BuddhaBless.printCornerTitle("06");
        test7flatMap();
        BuddhaBless.printCornerTitle("07");
        test8filter();
        BuddhaBless.printCornerTitle("08");
        test9pickAllWords();
        BuddhaBless.printCornerTitle("09");
        test10foreach();
        BuddhaBless.printCornerTitle("10");
        test11peek();
        BuddhaBless.printCornerTitle("11");
        test12reduce();
        BuddhaBless.printCornerTitle("12");
        test13limit();
        BuddhaBless.printCornerTitle("13");
        test14MinMax();
        BuddhaBless.printCornerTitle("14");
        test15operateWords();
        BuddhaBless.printCornerTitle("15");
        test16match();
        BuddhaBless.printCornerTitle("16");
        test17groupingBy();
        BuddhaBless.printCornerTitle("17");
        test18partitioningBy();
        BuddhaBless.printCornerTitle("18");
    }
