package cn.hl.kit.ox.snmp.trap;
...
public class MultiThreadedTrapReceiver implements CommandResponder {
    ...
    private void init() throws UnknownHostException, IOException {
        ...
        listenAddress = GenericAddress.parse(System.getProperty("snmp4j.listenAddress", "udp:10.195.88.96/162")); // 本地IP与监听端口
        ...
        UsmUser usmUser = new UsmUser(new OctetString(username), AuthMD5.ID, new OctetString(authPassword), Priv3DES.ID,
        ...
        */
        ...
        dispatcher = new MultiThreadedMessageDispatcher(threadPool, new MessageDispatcherImpl());
        //监听端的 IP地址 和 监听端口号
        listenAddress = GenericAddress.parse(System.getProperty("snmp4j.listenAddress", "udp:127.0.0.1/161"));
