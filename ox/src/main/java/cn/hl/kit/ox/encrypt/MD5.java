...
public class MD5 {
	 ...
	 * 可能出于效率的考虑把它们实现成了宏，在java中，我们把它们 实现成了private static方法，名字保持了原来C中的。
	 */
	...
	public static String getMD5String(String input) {
		input = Chinese2Pinyin.getFullSpell(input, false);
		md5Init();
	...
	public static void main(String[] args) {
		...
		System.out.println(MD5.getMD5String(sb.toString()));
		System.out.println("Cost: " + (System.nanoTime() - begintime) + "ns");

		begintime = System.nanoTime();
		System.out.println(MD5.getMD5String("忠蚊1"));
		System.out.println("Cost: " + (System.nanoTime() - begintime) + "ns");
		
		begintime = System.nanoTime();
		System.out.println(MD5.getMD5String("中文1"));
		System.out.println("Cost: " + (System.nanoTime() - begintime) + "ns");

		begintime = System.nanoTime();
		System.out.println(MD5.getMD5String("中文2"));
		System.out.println("Cost: " + (System.nanoTime() - begintime) + "ns");
	}
}
